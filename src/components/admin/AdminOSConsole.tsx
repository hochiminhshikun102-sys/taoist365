...
const workspaceMap = {
  ...
  "member-center": {
    ...
    work: ["Member profiles", "Verification status", "Credit score", "Member level", "Windkeep Supply entry", "Access review"],
  },
  "member-risk-control": {
  ...
  "client-runtime": {
    ...
    work: ["Dashboard", "My Objects", "My Orders", "Membership", "Windkeep Supply", "My AI", "Settings"],
    ai: ["My AI runtime", "Sharing points reserved", "Verification status", "Notifications", "Logistics loop", "Membership / reward loop"],
    mobile: ["Orders", "Objects", "Membership", "Windkeep Supply", "Verification status"],
  },
  windkeep: {
    id: "windkeep",
    cn: t.windkeep,
    ...
    state: "Rules linked",
    work: ["Passing Things", "Quiet Receiving", "Member supply intake", "Continuation Requests", "Risk link", "Object memory"],
  },
  driftbox: {
    id: "driftbox",
    cn: t.driftbox,
